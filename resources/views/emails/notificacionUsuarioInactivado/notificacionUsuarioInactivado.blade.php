...
<head>
    ...
    <title>{{ __('pleb.mail.Disable Title') }} | {{ config('app.name') }}</title>
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                            ...
                            <tr>
                                <td align="center" class="center-text">
                                    <img style="width:190px;border:0px;display: inline!important;" src="{{ __('pleb.mail.Email-2_Intro') }}" width="190" border="0"       alt="intro">
                                </td>
                            </tr>
                            <!-- gap -->
                            <tr>
                            ...
                            <tr>
                                <td class="center-text"  align="center" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:42px;line-height:52px;font-weight:400;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <div  >
                                        {{ __('pleb.mail.Disable Email') }} {{$user->nombre}} {{$user->apellidos}}{{ __('pleb.mail.Disable Email Sign') }}
                                    </div>
                            ...
                            <tr>
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <div  >
                                        {{ __('pleb.mail.Disable Paragraph') }}
                                    </div>
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="70" style="width:70px;max-width:70px;">
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <img style="display:block;width:100%;max-width:70px;border:0px;"    width="70" src="{{ __('pleb.mail.Disable Email Icon') }}" border="0"  alt="icon">
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
                                                            ...
                                                            @if( config('pleb.mail.instagram_url') != '')
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="{{ config('pleb.mail.instagram_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="{{ __('pleb.mail.instagran_icon') }}" width="36" border="0"       alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
