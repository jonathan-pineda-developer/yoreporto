                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="70" style="width:70px;max-width:70px;">
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <img style="display:block;width:100%;max-width:70px;border:0px;"    width="70" src="{{ __('pleb.mail.Verify Email Icon') }}" border="0"  alt="icon">
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
